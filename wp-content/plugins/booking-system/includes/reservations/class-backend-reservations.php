        ...
        function get(){
            ...
            foreach($reservations as $reservation) {
                ...
                if($reservation['price'] != 0) {
                    ...
                    array_push($excelReservationsData, '<td>'.str_replace('.', ',', $reservation['price']).'</td>');
                ...
                if($reservation['extras_price'] != 0) {
                    ...
                    array_push($excelReservationsData, '<td>'.str_replace('.', ',', $reservation['extras_price']).'</td>');
                ...
                if($reservation['fees_price'] != 0) {
                    ...
                    array_push($excelReservationsData, '<td>'.str_replace('.', ',', $reservation['fees_price']).'</td>');
                ...
                if($reservation['coupon_price'] != 0) {
                    ...
                    array_push($excelReservationsData, '<td>'.str_replace('.', ',', $reservation['coupon_price']).'</td>');
                ...
                if($reservation['deposit_price'] != 0) {
                    ...
                    array_push($excelReservationsData, '<td>'.str_replace('.', ',', $reservation['deposit_price']).'</td>');
                ...
                array_push($excelReservationsData, '<td>'.str_replace('.', ',', $reservation['price_total']).'</td>');
                ...
                array_push($excelReservationsData, '<td>'.$reservation['date_created'].'</td>');
