...
$TvrLang = array(
	...
	*/
	...
	'n_els' => esc_html__('Targets %s element on the page', 'microthemer'),
	'n_els_plural' => esc_html__('Targets %s elements on the page', 'microthemer'),
	...
	'parent_class_target_desc' => esc_html__('child <%s> elements inside parent <%s> container elements that have a class of <%s>', 'microthemer'),
	'parent_element_class_target' => esc_html__('Parent & element with class targeting', 'microthemer'),
	'parent_element_class_target_desc' => esc_html__('child <%s> elements that have a class of \'%s\' inside parent <%s> container elements that have a class of \'%s\'', 'microthemer'),
	'element_id_target' => esc_html__('Element ID targeting', 'microthemer'),
	'element_id_target_desc' => esc_html__('<%s> element with a unique id of \'%s\'', 'microthemer'),
	'parent_id_target' => esc_html__('Parent with ID targeting', 'microthemer'),
	'parent_id_target_desc' => esc_html__('child <%s> elements inside a parent <%s> container element that has a unique id of \'%s\'', 'microthemer'),
	'parent_id_element_class_target' => esc_html__('Parent with ID & element with class targeting', 'microthemer'),
	'parent_id_element_class_target_desc' => esc_html__('child <%s> elements that have a class of \'%s\' inside a parent <%s> container element that has a unique id of \'%s\'', 'microthemer'),
	'parent_element_id_target' => esc_html__('Parent & element with ID targeting', 'microthemer'),
	'parent_element_id_target_desc' => esc_html__('child <%s> element that has a unique id of \'%s\' inside a parent <%s> container element that has a unique id of \'%s\'', 'microthemer'),
