 ...
 */ ?>
		...
		<div class="content-main">
			...
			<p><?php /*echo wp_kses(
				sprintf(
					__('Microthemer can be used to style the mobile-only theme that WPTouch presents to mobile devices. In order to load the mobile theme in Microthemer\'s preview window, simply enable WPTouch mode using the toggle in the left toolbar. This toggle will only appear if Microthemer detects that you have installed and activated WPTouch. There is a <a %s>free</a> and <a %s>premium version</a> of WPTouch.', 'microthemer'),
